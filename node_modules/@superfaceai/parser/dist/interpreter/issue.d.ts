...
import { ObjectCollection, ObjectStructure, StructureType, VersionStructure } from './profile-output';
...
export declare type ValidationIssue = {
    ...
    context: ErrorContext & {
        expectedResult: StructureType | undefined;
    };
} | {
    kind: 'errorNotDefined';
    context: ErrorContext & {
        expectedError: StructureType | undefined;
    };
} | {
    kind: 'resultNotFound';
    context: ErrorContext & {
        actualResult: LiteralNode;
    };
} | {
    kind: 'errorNotFound';
    context: ErrorContext & {
        actualError: LiteralNode;
    };
} | {
    kind: 'inputNotFound';
    context: ErrorContext & {
