...
export declare type MapNodeKind = 'PrimitiveLiteral' | 'ObjectLiteral' | 'JessieExpression' | 'InlineCall' | 'Assignment' | 'ConditionAtom' | 'IterationAtom' | 'SetStatement' | 'OutcomeStatement' | 'CallStatement' | 'HttpRequest' | 'HttpResponseHandler' | 'HttpCallStatement' | 'MapDefinition' | 'OperationDefinition' | 'MapHeader' | 'MapDocument';
...
export declare type LiteralNode = ObjectLiteralNode | InlineCallNode | PrimitiveLiteralNode | JessieExpressionNode;
/**
...
export declare type HttpSecurityRequirement = {
    id: string;
...
export declare type Substatement = SetStatementNode | OutcomeStatementNode | CallStatementNode | HttpCallStatementNode;
...
export interface OperationDefinitionNode extends MapASTNodeBase, DocumentedNode {
...
export declare type MapASTNode = PrimitiveLiteralNode | ObjectLiteralNode | JessieExpressionNode | AssignmentNode | ConditionAtomNode | IterationAtomNode | SetStatementNode | OutcomeStatementNode | CallStatementNode | HttpRequestNode | HttpResponseHandlerNode | HttpCallStatementNode | MapDefinitionNode | OperationDefinitionNode | MapHeaderNode | MapDocumentNode | InlineCallNode;
