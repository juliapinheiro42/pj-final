...
function extractVersionString(input) {
    ...
    var _a = __read(split_1.splitLimit(input, '@', 1), 2), version = _a[1];
...
function extractVersion(versionString) {
    var _a = __read(split_1.splitLimit(versionString, '-', 1), 2), version = _a[0], label = _a[1];
    var _b = __read(split_1.splitLimit(version, '.', 2), 3), majorStr = _b[0], minorStr = _b[1], patchStr = _b[2];
