...
function visitDateType(type, visitorContext) {
    ...
    return VisitorUtils.setFunctionIfNotExists(name, visitorContext, () => {
        return ts.createFunctionDeclaration(undefined, undefined, undefined, name, undefined, [ts.createParameter(undefined, undefined, undefined, VisitorUtils.objectIdentifier, undefined, undefined, undefined)], undefined, ts.createBlock([
            ts.createVariableStatement(undefined, ts.createVariableDeclarationList([ts.createVariableDeclaration(ts.createIdentifier('nativeDateObject'), undefined, undefined)], ts.NodeFlags.Let)),
...
function visitTupleObjectType(type, visitorContext) {
    ...
    return VisitorUtils.setFunctionIfNotExists(name, visitorContext, () => {
        ...
        return ts.createFunctionDeclaration(undefined, undefined, undefined, name, undefined, [
            ...
            ts.createIf(VisitorUtils.createBinaries([
                ts.createLogicalNot(ts.createCall(ts.createPropertyAccess(ts.createIdentifier('Array'), 'isArray'), undefined, [VisitorUtils.objectIdentifier])),
                ts.createBinary(ts.createPropertyAccess(VisitorUtils.objectIdentifier, 'length'), ts.SyntaxKind.LessThanToken, ts.createNumericLiteral(minLength.toString())),
...
function visitRegularObjectType(type, visitorContext) {
    ...
    return VisitorUtils.setFunctionIfNotExists(name, visitorContext, () => {
        ...
        return ts.createFunctionDeclaration(undefined, undefined, undefined, name, undefined, [
            ...
            VisitorUtils.createStrictNullCheckStatement(VisitorUtils.objectIdentifier, visitorContext),
            ts.createIf(VisitorUtils.createBinaries([
                ts.createStrictInequality(ts.createTypeOf(VisitorUtils.objectIdentifier), ts.createStringLiteral('object')),
                ts.createStrictEquality(VisitorUtils.objectIdentifier, ts.createNull()),
...
function visitNonPrimitiveType(type, visitorContext) {
    ...
    if (intrinsicName === 'object') {
        ...
        return VisitorUtils.setFunctionIfNotExists(name, visitorContext, () => {
            const conditions = [
                ts.createStrictInequality(ts.createTypeOf(VisitorUtils.objectIdentifier), ts.createStringLiteral('boolean')),
                ts.createStrictInequality(ts.createTypeOf(VisitorUtils.objectIdentifier), ts.createStringLiteral('number')),
                ts.createStrictInequality(ts.createTypeOf(VisitorUtils.objectIdentifier), ts.createStringLiteral('string')),
                ts.createStrictInequality(VisitorUtils.objectIdentifier, ts.createNull()),
                ts.createStrictInequality(VisitorUtils.objectIdentifier, ts.createIdentifier('undefined'))
            ];
...
function visitTemplateLiteralType(type, visitorContext) {
    const name = VisitorTypeName.visitType(type, visitorContext, { type: 'type-check' });
    const typePairs = type.texts.reduce((prev, curr, i) => [...prev, [curr, typeof type.types[i] === 'undefined' ? undefined : VisitorUtils.getIntrinsicName(type.types[i])]], []);
    ...
    return VisitorUtils.setFunctionIfNotExists(name, visitorContext, () => ts.factory.createFunctionDeclaration(undefined, undefined, undefined, name, undefined, [
        ts.factory.createParameterDeclaration(undefined, undefined, undefined, VisitorUtils.objectIdentifier, undefined, ts.factory.createKeywordTypeNode(ts.SyntaxKind.StringKeyword), undefined)
    ], undefined, ts.factory.createBlock([
        ts.factory.createVariableStatement(undefined, ts.factory.createVariableDeclarationList([ts.factory.createVariableDeclaration(ts.factory.createIdentifier('typePairs'), undefined, undefined, ts.factory.createArrayLiteralExpression(typePairs.map(([text, type]) => ts.factory.createArrayLiteralExpression([
                ts.factory.createStringLiteral(text),
                typeof type === 'undefined'
                    ? ts.factory.createIdentifier('undefined')
                    : ts.factory.createStringLiteral(type)
            ])), false))], ts.NodeFlags.Const)),
        ts.factory.createVariableStatement(undefined, ts.factory.createVariableDeclarationList([ts.factory.createVariableDeclaration(ts.factory.createIdentifier('position'), undefined, undefined, ts.factory.createNumericLiteral('0'))], ts.NodeFlags.Let)),
        ts.factory.createForOfStatement(undefined, ts.factory.createVariableDeclarationList([ts.factory.createVariableDeclaration(ts.factory.createArrayBindingPattern([
                ts.factory.createBindingElement(undefined, undefined, ts.factory.createIdentifier('index'), undefined),
                ts.factory.createBindingElement(undefined, undefined, ts.factory.createIdentifier('typePair'), undefined)
            ]), undefined, undefined, undefined)], ts.NodeFlags.Const), ts.factory.createCallExpression(ts.factory.createPropertyAccessExpression(ts.factory.createIdentifier('typePairs'), ts.factory.createIdentifier('entries')), undefined, []), ts.factory.createBlock([
            ts.factory.createVariableStatement(undefined, ts.factory.createVariableDeclarationList([ts.factory.createVariableDeclaration(ts.factory.createArrayBindingPattern([
                    ts.factory.createBindingElement(undefined, undefined, ts.factory.createIdentifier('currentText'), undefined),
                    ts.factory.createBindingElement(undefined, undefined, ts.factory.createIdentifier('currentType'), undefined)
                ]), undefined, undefined, ts.factory.createIdentifier('typePair'))], ts.NodeFlags.Const)),
            ts.factory.createVariableStatement(undefined, ts.factory.createVariableDeclarationList([ts.factory.createVariableDeclaration(ts.factory.createArrayBindingPattern([
                    ts.factory.createBindingElement(undefined, undefined, ts.factory.createIdentifier('nextText'), undefined),
                    ts.factory.createBindingElement(undefined, undefined, ts.factory.createIdentifier('nextType'), undefined)
                ]), undefined, undefined, ts.factory.createBinaryExpression(ts.factory.createElementAccessExpression(ts.factory.createIdentifier('typePairs'), ts.factory.createBinaryExpression(ts.factory.createIdentifier('index'), ts.factory.createToken(ts.SyntaxKind.PlusToken), ts.factory.createNumericLiteral('1'))), ts.factory.createToken(ts.SyntaxKind.QuestionQuestionToken), ts.factory.createArrayLiteralExpression([
                    ts.factory.createIdentifier('undefined'),
                    ts.factory.createIdentifier('undefined')
                ], false)))], ts.NodeFlags.Const)),
            ts.factory.createIfStatement(ts.factory.createBinaryExpression(ts.factory.createCallExpression(ts.factory.createPropertyAccessExpression(VisitorUtils.objectIdentifier, ts.factory.createIdentifier('substr')), undefined, [
                ts.factory.createIdentifier('position'),
                ts.factory.createPropertyAccessExpression(ts.factory.createIdentifier('currentText'), ts.factory.createIdentifier('length'))
            ]), ts.factory.createToken(ts.SyntaxKind.ExclamationEqualsEqualsToken), ts.factory.createIdentifier('currentText')), ts.factory.createReturnStatement(templateLiteralTypeError), undefined),
            ts.factory.createExpressionStatement(ts.factory.createBinaryExpression(ts.factory.createIdentifier('position'), ts.factory.createToken(ts.SyntaxKind.PlusEqualsToken), ts.factory.createPropertyAccessExpression(ts.factory.createIdentifier('currentText'), ts.factory.createIdentifier('length')))),
            ts.factory.createIfStatement(ts.factory.createBinaryExpression(ts.factory.createBinaryExpression(ts.factory.createIdentifier('nextText'), ts.factory.createToken(ts.SyntaxKind.EqualsEqualsEqualsToken), ts.factory.createStringLiteral('')), ts.factory.createToken(ts.SyntaxKind.AmpersandAmpersandToken), ts.factory.createBinaryExpression(ts.factory.createIdentifier('nextType'), ts.factory.createToken(ts.SyntaxKind.ExclamationEqualsEqualsToken), ts.factory.createIdentifier('undefined'))), ts.factory.createBlock([
                ts.factory.createVariableStatement(undefined, ts.factory.createVariableDeclarationList([ts.factory.createVariableDeclaration(ts.factory.createIdentifier('char'), undefined, undefined, ts.factory.createCallExpression(ts.factory.createPropertyAccessExpression(VisitorUtils.objectIdentifier, ts.factory.createIdentifier('charAt')), undefined, [ts.factory.createIdentifier('position')]))], ts.NodeFlags.Const)),
                ts.factory.createIfStatement(ts.factory.createBinaryExpression(ts.factory.createParenthesizedExpression(ts.factory.createBinaryExpression(ts.factory.createParenthesizedExpression(ts.factory.createBinaryExpression(ts.factory.createBinaryExpression(ts.factory.createIdentifier('currentType'), ts.factory.createToken(ts.SyntaxKind.EqualsEqualsEqualsToken), ts.factory.createStringLiteral('number')), ts.factory.createToken(ts.SyntaxKind.BarBarToken), ts.factory.createBinaryExpression(ts.factory.createIdentifier('currentType'), ts.factory.createToken(ts.SyntaxKind.EqualsEqualsEqualsToken), ts.factory.createStringLiteral('bigint')))), ts.factory.createToken(ts.SyntaxKind.AmpersandAmpersandToken), ts.factory.createCallExpression(ts.factory.createIdentifier('isNaN'), undefined, [ts.factory.createCallExpression(ts.factory.createIdentifier('Number'), undefined, [ts.factory.createIdentifier('char')])]))), ts.factory.createToken(ts.SyntaxKind.BarBarToken), ts.factory.createParenthesizedExpression(ts.factory.createBinaryExpression(ts.factory.createParenthesizedExpression(ts.factory.createBinaryExpression(ts.factory.createBinaryExpression(ts.factory.createIdentifier('currentType'), ts.factory.createToken(ts.SyntaxKind.EqualsEqualsEqualsToken), ts.factory.createStringLiteral('string')), ts.factory.createToken(ts.SyntaxKind.BarBarToken), ts.factory.createBinaryExpression(ts.factory.createIdentifier('currentType'), ts.factory.createToken(ts.SyntaxKind.EqualsEqualsEqualsToken), ts.factory.createStringLiteral('any')))), ts.factory.createToken(ts.SyntaxKind.AmpersandAmpersandToken), ts.factory.createBinaryExpression(ts.factory.createIdentifier('char'), ts.factory.createToken(ts.SyntaxKind.EqualsEqualsEqualsToken), ts.factory.createStringLiteral(''))))), ts.factory.createReturnStatement(templateLiteralTypeError), undefined)
            ], true), undefined),
            ts.factory.createVariableStatement(undefined, ts.factory.createVariableDeclarationList([ts.factory.createVariableDeclaration(ts.factory.createIdentifier('nextTextOrType'), undefined, undefined, ts.factory.createConditionalExpression(ts.factory.createBinaryExpression(ts.factory.createIdentifier('nextText'), ts.factory.createToken(ts.SyntaxKind.EqualsEqualsEqualsToken), ts.factory.createStringLiteral('')), ts.factory.createToken(ts.SyntaxKind.QuestionToken), ts.factory.createIdentifier('nextType'), ts.factory.createToken(ts.SyntaxKind.ColonToken), ts.factory.createIdentifier('nextText')))], ts.NodeFlags.Const)),
            ts.factory.createVariableStatement(undefined, ts.factory.createVariableDeclarationList([ts.factory.createVariableDeclaration(ts.factory.createIdentifier('resolvedPlaceholder'), undefined, undefined, ts.factory.createCallExpression(ts.factory.createPropertyAccessExpression(VisitorUtils.objectIdentifier, ts.factory.createIdentifier('substring')), undefined, [
                    ts.factory.createIdentifier('position'),
                    ts.factory.createConditionalExpression(ts.factory.createBinaryExpression(ts.factory.createTypeOfExpression(ts.factory.createIdentifier('nextTextOrType')), ts.factory.createToken(ts.SyntaxKind.EqualsEqualsEqualsToken), ts.factory.createStringLiteral('undefined')), ts.factory.createToken(ts.SyntaxKind.QuestionToken), ts.factory.createBinaryExpression(ts.factory.createPropertyAccessExpression(VisitorUtils.objectIdentifier, ts.factory.createIdentifier('length')), ts.factory.createToken(ts.SyntaxKind.MinusToken), ts.factory.createNumericLiteral('1')), ts.factory.createToken(ts.SyntaxKind.ColonToken), ts.factory.createCallExpression(ts.factory.createPropertyAccessExpression(VisitorUtils.objectIdentifier, ts.factory.createIdentifier('indexOf')), undefined, [
                        ts.factory.createIdentifier('nextTextOrType'),
                        ts.factory.createIdentifier('position')
                    ]))
                ]))], ts.NodeFlags.Const)),
            ts.factory.createIfStatement(ts.factory.createBinaryExpression(ts.factory.createBinaryExpression(ts.factory.createBinaryExpression(ts.factory.createParenthesizedExpression(ts.factory.createBinaryExpression(ts.factory.createBinaryExpression(ts.factory.createIdentifier('currentType'), ts.factory.createToken(ts.SyntaxKind.EqualsEqualsEqualsToken), ts.factory.createStringLiteral('number')), ts.factory.createToken(ts.SyntaxKind.AmpersandAmpersandToken), ts.factory.createCallExpression(ts.factory.createIdentifier('isNaN'), undefined, [ts.factory.createCallExpression(ts.factory.createIdentifier('Number'), undefined, [ts.factory.createIdentifier('resolvedPlaceholder')])]))), ts.factory.createToken(ts.SyntaxKind.BarBarToken), ts.factory.createParenthesizedExpression(ts.factory.createBinaryExpression(ts.factory.createBinaryExpression(ts.factory.createIdentifier('currentType'), ts.factory.createToken(ts.SyntaxKind.EqualsEqualsEqualsToken), ts.factory.createStringLiteral('bigint')), ts.factory.createToken(ts.SyntaxKind.AmpersandAmpersandToken), ts.factory.createParenthesizedExpression(ts.factory.createBinaryExpression(ts.factory.createCallExpression(ts.factory.createPropertyAccessExpression(ts.factory.createIdentifier('resolvedPlaceholder'), ts.factory.createIdentifier('includes')), undefined, [ts.factory.createStringLiteral('.')]), ts.factory.createToken(ts.SyntaxKind.BarBarToken), ts.factory.createCallExpression(ts.factory.createIdentifier('isNaN'), undefined, [ts.factory.createCallExpression(ts.factory.createIdentifier('Number'), undefined, [ts.factory.createIdentifier('resolvedPlaceholder')])])))))), ts.factory.createToken(ts.SyntaxKind.BarBarToken), ts.factory.createParenthesizedExpression(ts.factory.createBinaryExpression(ts.factory.createBinaryExpression(ts.factory.createIdentifier('currentType'), ts.factory.createToken(ts.SyntaxKind.EqualsEqualsEqualsToken), ts.factory.createStringLiteral('undefined')), ts.factory.createToken(ts.SyntaxKind.AmpersandAmpersandToken), ts.factory.createBinaryExpression(ts.factory.createIdentifier('resolvedPlaceholder'), ts.factory.createToken(ts.SyntaxKind.ExclamationEqualsEqualsToken), ts.factory.createStringLiteral('undefined'))))), ts.factory.createToken(ts.SyntaxKind.BarBarToken), ts.factory.createParenthesizedExpression(ts.factory.createBinaryExpression(ts.factory.createBinaryExpression(ts.factory.createIdentifier('currentType'), ts.factory.createToken(ts.SyntaxKind.EqualsEqualsEqualsToken), ts.factory.createStringLiteral('null')), ts.factory.createToken(ts.SyntaxKind.AmpersandAmpersandToken), ts.factory.createBinaryExpression(ts.factory.createIdentifier('resolvedPlaceholder'), ts.factory.createToken(ts.SyntaxKind.ExclamationEqualsEqualsToken), ts.factory.createStringLiteral('null'))))), ts.factory.createReturnStatement(templateLiteralTypeError), undefined),
            ts.factory.createExpressionStatement(ts.factory.createBinaryExpression(ts.factory.createIdentifier('position'), ts.factory.createToken(ts.SyntaxKind.PlusEqualsToken), ts.factory.createPropertyAccessExpression(ts.factory.createIdentifier('resolvedPlaceholder'), ts.factory.createIdentifier('length'))))
        ], true)),
...
function visitUndefinedOrType(type, visitorContext) {
    ...
    return VisitorUtils.setFunctionIfNotExists(name, visitorContext, () => {
        ...
        return ts.createFunctionDeclaration(undefined, undefined, undefined, name, undefined, [
            ...
            ts.createIf(ts.createStrictInequality(VisitorUtils.objectIdentifier, ts.createIdentifier('undefined')), ts.createBlock([
                ts.createVariableStatement([ts.createModifier(ts.SyntaxKind.ConstKeyword)], [
